...
```typescript
// GET /v1/store/products?category=&agents=&priceMin=&priceMax=&rating=&sort=&page=&limit=
// OpenAPI: #operation/Store.listProducts
...
// OpenAPI: #operation/Store.addToCart
...
// GET /v1/store/cart
// OpenAPI: #operation/Store.getCart
export async function GET(request: Request) {
  try {
    const session = await getSession(request);
    if (!session) {
...
// OpenAPI: #operation/Store.purchase
