...
// OpenAPI: #operation/Stats.getPlatformStats
...
```typescript
// GET /v1/agents
// OpenAPI: #operation/Agents.listAgents
...
```typescript
// GET /v1/activities/recent?limit=10
// OpenAPI: #operation/Activities.listRecentActivities
...
```typescript
// GET /v1/testimonials?featured=true
// OpenAPI: #operation/Testimonials.listTestimonials
